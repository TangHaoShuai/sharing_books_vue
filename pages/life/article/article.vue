<template>
	<!-- 文章详细内容 -->
	<view>
		<u-navbar :custom-back="back" leftText="返回" title="文章内容" :safeAreaInsetTop="false" :background="background"
			:height="48">
		...
		<view class="u-page">
			<view>
				<u-row style="margin: 10rpx;">
					<u-col span="1.4">
						<u-avatar v-if="data.user.url" :size=" 70" :src="url+data.user.url"></u-avatar>
					</u-col>
			...
			<view class="u-content">
				...
				<view style="margin: 20rpx;">
					<u-image border-radius="30" style="margin-top: 20rpx;" width="100%" height="500rpx"
						mode="aspectFill" v-for="(item,index) in this.data.imgLists" :src="imgurl+item.imgUrl">
					</u-image>
				</view>
					...
					<u-row>
						...
						<u-col span="3.5">
							<u-row justify="flex-end">
								<!-- 三个点点 -->
								<u-icon @click="praise_comment_show = true" name="../../../static/diandian.png"
									size="34" color="" label="" />
							</u-row>
						</u-col>
					</u-row>
				...
				<u-action-sheet @click="praise_comment_click" :list="praise_comment" v-model="praise_comment_show">
				</u-action-sheet>
			</view>
			<view class="">
	...
	export default {
		data() {
			return {
				...
				imgurl: this.$article_img_url, //文章图片
				url: this.$tx_url, //头像
				data: {
					user: {
						phone: ''
